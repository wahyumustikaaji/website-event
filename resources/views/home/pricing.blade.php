        ...
        <div class="relative z-10">
            ...
            <div class="overflow-hidden">
                <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-20 lg:mt-28">
                    ...
                    <div class="max-w-2xl mx-auto text-center mb-10">
                        ...
                        <p class="mt-2 lg:text-lg text-gray-800 dark:text-neutral-200">Whatever your status, our offers
                            evolve according to
                            your needs.</p>
                    </div>
                    <!-- End Title -->
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-neutral-500">Everything a small team
                                        needs.</div>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="text-sm text-gray-500 dark:text-neutral-500">For growing businesses.
                                    </div>
                                    <span
                                        class="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 dark:bg-white dark:text-neutral-800">Most
                                        popular</span>
            ...
            <div class="relative">
                <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
                    ...
                    <!-- Header -->
                    <div
                        class="hidden lg:block sticky top-0 start-0 py-2 bg-white/60 backdrop-blur-md dark:bg-neutral-900/60">
                        <!-- Grid -->
                        ...
                        <ul class="grid lg:grid-cols-6 lg:gap-6">
                            ...
                            <li class="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-neutral-800">
                                <div class="grid grid-cols-2 md:grid-cols-6 lg:block">
                                    ...
                                    <svg class="shrink-0 size-5 text-blue-600 dark:text-blue-500"
                    ...
                    <div class="hidden lg:block mt-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-1">
                                <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                                    href="#">
                                    Get started
                                </a>
                            </div>
