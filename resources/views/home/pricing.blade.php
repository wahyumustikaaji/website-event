    ...
    <div class="relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <div class="overflow-hidden">
                <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-20 lg:mt-28">
                    <!-- Title -->
                    <div class="max-w-2xl mx-auto text-center mb-10">
                        <h2
                            class="text-3xl leading-tight font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight bg-clip-text bg-gradient-to-r from-violet-600 to-blue-700 text-transparent">
                            Kelola Event dengan Mudah</h2>
                        <p class="mt-2 lg:text-lg text-gray-800 dark:text-neutral-200">Pilih paket terbaik untuk acara
                            Anda, lacak peserta, dan optimalkan pengalaman event dengan fitur canggih.</p>
                    </div>
                    <!-- End Title -->
                    ...
                    <div class="relative xl:w-10/12 xl:mx-auto">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                            <div>
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">Free Plan</h3>
                                    <div class="text-sm text-gray-500 dark:text-neutral-500">Untuk event kecil yang
                                        ingin mulai tanpa biaya.</div>

                                    <div class="mt-5">
                                        <span class="text-6xl font-bold text-gray-800 dark:text-neutral-200">Rp.
                                            0</span>
                                        <span class="text-lg font-bold text-gray-800 dark:text-neutral-200"></span>
                                        <span class="ms-3 text-gray-500 dark:text-neutral-500">/ Bulan</span>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <ul class="space-y-2 text-sm sm:text-base">
                                            <li class="flex gap-x-3">
                                                <span
                                                    class="size-5 flex justify-center items-center rounded-full bg-gray-50 text-gray-500 dark:bg-neutral-800 dark:text-neutral-500">
                                                    <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round">
                                    ...
                                    <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                                        <div>
                                            <p class="text-sm text-gray-500 dark:text-neutral-500">Bisa dibatalkan kapan
                                                saja.</p>
                                            <p class="text-sm text-gray-500 dark:text-neutral-500">Tidak perlu kartu
                                                kredit.</p>
                                        </div>
                                        ...
                                        <div class="flex justify-end">
                                            ...
                                            <button type="button"
                                                ...
                                                route('login') . "'" }}">
                                                {{ auth()->check() ? 'Plan Saat ini' : 'Start free trial' }}
                                            </button>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div>
                                <!-- Card -->
                                <div
                                    class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800 dark:shadow-gray-900/20">
                                    <h3 class="text-xl font-bold text-gray-800 dark:text-neutral-200">Pro Plan</h3>
                                    <div class="text-sm text-gray-500 dark:text-neutral-500">Untuk event profesional
                                        dengan wawasan mendalam.
                                    </div>
                                    <span
                                        class="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-gray-800 text-white py-1.5 px-3 dark:bg-white dark:text-neutral-800">Paling
                                        Populer</span>

                                    <div class="mt-5">
                                        <span class="text-6xl font-bold text-gray-800 dark:text-neutral-200">Rp.
                                            50</span>
                                        <span class="text-lg font-bold text-gray-800 dark:text-neutral-200">.000</span>
                                        <span class="ms-3 text-gray-500 dark:text-neutral-500">/ Bulan</span>
                                    </div>
                                    ...
                                    <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                                        ...
                                        @endphp
                                        <div class="flex justify-end">
                                            <button type="button" @if($isPremium) disabled @else
                                                onclick="window.location.href='{{ route('payment.show') }}'" @endif
                        ...
                        <div class="hidden md:block absolute bottom-0 start-0 translate-y-16 -translate-x-16">
                            <svg class="w-56 h-auto text-cyan-500" width="347" height="188" viewBox="0 0 347 188"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="mt-7 text-center">
                        <p class="text-xs text-gray-400">
                            Harga dalam rupiah, pajak mungkin berlaku.
                        </p>
                    </div>
                </div>
            </div>
