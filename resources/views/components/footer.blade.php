<!-- ========== FOOTER ========== -->
<footer class="mx-4 md:mx-6 lg:mx-10 mb-5 mt-8 lg:mt-16">
    <div class="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-neutral-900 dark:bg-black rounded-2xl">
        <!-- Grid -->
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
            ...
            <div>
                <h4 class="text-xs font-semibold uppercase text-neutral-100">Product</h4>

                <div class="mt-3 grid space-y-3 text-sm">
                    <p><a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Pricing</a></p>
                    <p><a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Changelog</a></p>
                    <p><a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
            ...
            <div>
                <h4 class="text-xs font-semibold uppercase text-neutral-100">Company</h4>
            ...
            <div>
                <h4 class="text-xs font-semibold uppercase text-neutral-100">Resources</h4>
            ...
            <div>
                <h4 class="text-xs font-semibold uppercase text-neutral-100">Developers</h4>
                ...
                <h4 class="mt-7 text-xs font-semibold uppercase text-neutral-100">Industries</h4>
        ...
        <div class="pt-5 mt-5 border-t border-gray-200 dark:border-neutral-700">
            <div class="sm:flex sm:justify-between sm:items-center">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="hs-dropdown [--placement:top-left] relative inline-flex">
                        <button id="hs-footer-language-dropdown" type="button"
                            class="hs-dropdown-toggle py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-lg border border-gray-200 bg-white  shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                        ...
                        <div class="hs-dropdown-menu w-40 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 bg-white shadow-md rounded-lg p-2 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700"
                            ...
                            <a class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm  hover:bg-gray-100 focus:outline-none focus:bg-gray-100 text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                                href="#">
                    ...
                    <div class="space-x-4 text-sm">
                        <a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Terms</a>
                        <a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">Privacy</a>
                        <a class="inline-flex gap-x-2 focus:outline-none focus: text-neutral-400 hover:text-neutral-200 dark:focus:text-neutral-200"
                ...
                <div class="flex flex-wrap justify-between items-center gap-3">
                    ...
                    <!-- Social Brands -->
                    <div class="space-x-4">
                        <a class="inline-block text-gray-500 focus:outline-none focus: dark:text-neutral-500 hover:text-neutral-200 dark:focus:text-neutral-200"
                            href="#">
