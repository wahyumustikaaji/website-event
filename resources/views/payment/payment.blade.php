<x-guest-layout>
    <div class="relative overflow-hidden">
        ...
        <div class="relative z-10">
            <!-- Card Blog -->
            <div class="max-w-xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-16">
                <div class="ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                    <div
                        ...
                        <div
                            class="relative overflow-hidden min-h-32 bg-gray-900 text-center rounded-t-xl dark:bg-neutral-950">
                        ...
                        <div class="p-4 sm:p-7 overflow-y-auto">
                            ...
                            <div class="mt-8 flex justify-end gap-x-2">
                                <button id="pay-button"
                                    class="py-2 px-3 w-full inline-flex items-center justify-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                    Bayar Sekarang
                                </button>
                            </div>
                            <!-- End Buttons -->
                            ...
                            <div class="mt-5 sm:mt-10">
                                <p class="text-sm text-gray-500 dark:text-neutral-500">If you have any questions,
                                    please contact us
                                    at <a
